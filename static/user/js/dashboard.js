(function($) {
  ...
  $(function() {
    ...
    if ($("#visit-sale-chart").length) {
	  ...
	  var ajax_top;
      $.ajax({url:"/admin/ajax_top/",async: false,success: function(result){ajax_top=result;}});
      
	  var myChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Port', 'Fuzz', 'Exp', 'Nmap', 'SQLmap', 'Spider', 'CTF'],
            datasets: [
              {
                label: "Tools Details",
                borderColor: gradientStrokeViolet,
                ...
                borderWidth: 3,
                fill: 'origin',
                data: [ajax_top.list.Port, ajax_top.list.Fuzz, ajax_top.list.Exp, 1, 1, ajax_top.list.Spider, 10]
              }
          ]
        },
        options: {
    ...
    if ($("#traffic-chart").length) {
	  ...
	  var trafficChartData = {
		labels: [
          ajax_top.topdata[0].name_data,
		  ajax_top.topdata[1].name_data,
		  ajax_top.topdata[2].name_data,
        ],
		datasets: [{
          data: [ajax_top.percent[0].p, ajax_top.percent[1].p, ajax_top.percent[2].p],
          backgroundColor: [
            gradientStrokeBlue,
            gradientStrokeGreen,
            gradientStrokeRed
